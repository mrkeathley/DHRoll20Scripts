...
var Ammo = Ammo || (function () {
    ...
    var version = '0.3.11',
        ...
        adjustAmmo = function (ec) {
            ...
            let reload = ec.operation.reload;
            ...
            if (reload === 'N/A') {
                sendMessage(
                    '<b>' + chr.get('name') + '</b> fires without consuming ammo.',
                    who,
                    ec.output.whisper
                );
                return;
        ...
        HandleInput = function (msg_orig) {
            ...
            let attr, amount, chr, token, reload, label;
