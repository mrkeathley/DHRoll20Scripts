...
Using a source token, no target, range entered on usage. Grenade with deviation. <pre>!dh_2nd {{<br>--source\|@{selected\|token_id}<br>--range\|?{Range\|5}<br>--weapon\|Frag Grenade<br>--action\|weapon<br>--attack_type\|standard<br>--aim\|?{Aim\|none\|half\|full}<br>}}</pre>|![Example7](img/example_7.png)
